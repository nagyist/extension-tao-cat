...
namespace oat\taoCat\controller;

use common_session_SessionManager;
use tao_actions_ServiceModule;
use taoResultServer_models_classes_ResultServerStateFull;
use oat\taoCat\model\TestAssembler;
use oat\taoCat\model\routing\Plan;
use oat\taoCat\model\routing\Route;
use oat\taoCat\helpers\TestContext;
...
class TestRunner extends tao_actions_ServiceModule
{
     ...
     * 
     * @var \oat\taoCat\model\routing\Route
     */
    private $route = null;
     ...
     * 
     * @return \oat\taoCat\model\routing\Plan
     */
     ...
     * 
     * @return \oat\taoCat\model\routing\Route
     */
