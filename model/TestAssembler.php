    ...
    public function compile() 
    {
        ...
        file_put_contents($fileName, '<?php return ' . common_Utils::toPHPVariableString(array(
         ...
         if ($report->getType() == common_report_Report::TYPE_SUCCESS) {
             $service = new tao_models_classes_service_ServiceCall(new core_kernel_classes_Resource(INSTANCE_CATTEST_TESTRUNNERSERVICE));
             ...
             $param = new tao_models_classes_service_ConstantParameter(
                 new core_kernel_classes_Resource(INSTANCE_FORMALPARAM_CATTEST_DEFINITION),
             ...
             $param = new tao_models_classes_service_ConstantParameter(
                 new core_kernel_classes_Resource(INSTANCE_FORMALPARAM_CATTEST_COMPILATION),
                 $private->getId()
             );
             $service->addInParameter($param);
