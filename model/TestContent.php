...
class TestContent 
{
    ...
    static public function setItems(core_kernel_classes_Resource $test, array $items) 
    {
        ...
        $content->editPropertyValues(new core_kernel_classes_Property(PROPERTY_CAT_TEST_CONTENT_ITEMS), $items); 
    }
    ...
    static public function getItems(core_kernel_classes_Resource $test) 
    {
        ...
        $items = array();
        $prop = new core_kernel_classes_Property(PROPERTY_CAT_TEST_CONTENT_ITEMS);
    ...
    static public function getContent(core_kernel_classes_Resource $test) 
    {
        ...
        if (count($props) == 1) {
            ...
            $class = new core_kernel_classes_Class(CLASS_CAT_TEST_CONTENT);
