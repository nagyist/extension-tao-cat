...
use oat\taoCat\model\mapping\ItemIdentifierMapper;
...
abstract class TestModel implements taoTests_models_classes_TestModel
{
    ...
    {
        $content = TestContent::getContent($test);
        $tree = tao_helpers_form_GenerisTreeForm::buildTree($content, new core_kernel_classes_Property(PROPERTY_CAT_TEST_CONTENT_ITEMS));
        return $tree->render();
    }
    ...
    {
        return 'oat\taoCat\model\TestAssembler';
    }
